require(
    ...
    function () {
        ...
        console.log("If you want to skip this game, copy below:");
        ...
        var wingame = function(){
            ...
            clearTimeout(timer);
            //create a win box
            alert("That was close! You submitted in time!\nYou don't really win in a lose-lose situation. Click 'OK' to advance to the next stage.");
